...
void DESPOT::BeliefUpdate(ACT_TYPE action, OBS_TYPE obs) {
	...
	cout << "action is time t-1, this belief is related to state shown in previous time slice" << endl;
	cout << "Previous belief (the action shown was selected with this belief)" << endl;
	cout <<  " P(Posi==Left) " << Globals::config.current_satisfaction_criteria[0] <<endl;
	cout <<  " P(Posi==Right) " << Globals::config.current_satisfaction_criteria[1] <<endl;
	Globals::config.jlog_["current_belief_tiger_left_(s)"]=Globals::config.current_satisfaction_criteria[0];
	Globals::config.jlog_["current_belief_tiger_right_(s)"]=Globals::config.current_satisfaction_criteria[1];
	...
	cout <<  " P(Posi==Left) " << Globals::config.current_satisfaction_criteria[0] <<endl;
	cout <<  " P(Posi==Right) " << Globals::config.current_satisfaction_criteria[1] <<endl;
	Globals::config.jlog_["updated_belief_tiger_left_(s')"]=Globals::config.current_satisfaction_criteria[0];
	Globals::config.jlog_["updated_belief_tiger_right_(s')"]=Globals::config.current_satisfaction_criteria[1];
